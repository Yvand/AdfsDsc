...
ConvertFrom-StringData @'
    ...
    ResourceDuplicateServiceCertificateErrorMessage     = Only one of the service certificate parameters 'CertificateThumbprint' or 'CertificateDnsName' should be specified. (FRMERR008)
    ResourceMissingServiceCertificateErrorMessage       = One of the service certificate parameters 'CertificateThumbprint' or 'CertificateDnsName' must be specified. (FRMERR009)
    ...
    ParameterCertificateDnsNameInvalidErrorMessage = Could not find a certificate with Subject '{0}'. (FRMERR007)
